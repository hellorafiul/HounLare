      ...
      <div className="container footer-area">
        <div className="row d-flex justify-content-between align-items-start py-5">
          <div className="col-md-7 footer-menu align-items-end">
            ...
            <p className="pt-4 d-md-block d-none">&copy; 2021 Hounlare, Inc. All rights reserved</p>
          </div>
          ...
          <p className="d-md-none pt-4 text-white">&copy; 2021 Hounlare, Inc. All rights reserved</p>
        </div>
      </div>
    </footer>
  );
